...
namespace TrickyLib.Index.Lucene.Analysis.Snowball
{
    ...
    public class SnowballAnalyzer : Analyzer
    {
        ...
        public SnowballAnalyzer(Version matchVersion, System.String stemmerName, bool useStopWords, string wordNetFilePath = "Resource/wordnet.dict.txt")
        {
            ...
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("TrickyLib.Resource.stopword.txt"))
