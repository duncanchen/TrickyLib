...
using TokenFilter = TrickyLib.Index.Lucene.Analysis.TokenFilter;
...
namespace TrickyLib.Index.Lucene.Analysis.Snowball
{
	...
	public sealed class SnowballFilter : TokenFilter
	{
		...
		/// </param>
		public SnowballFilter(TokenStream input, System.String name, string wordNetFilePath) : base(input)
		{
			try
			{
                ...
                if (name == "Lingo")
                    ((LingoStemmer)stemmer).WordNetFilePath = wordNetFilePath;
			}
