...
namespace TrickyLib.Index.Lucene.Analysis
{
	...
	public abstract class Analyzer : IDisposable
	{
        ...
        public IEnumerable<string> Tokenize(string str)
        {
            ...
            Lucene.Analysis.TokenStream tokenStream = TokenStream("defaultFieldName", stringReader);
            while (tokenStream.IncrementToken())
            {
                var iToken = tokenStream.AddAttribute<ITermAttribute>();
                yield return iToken.Term;
            }
        }
	}
}