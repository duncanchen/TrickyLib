...
using CharReader = TrickyLib.Index.Lucene.Analysis.CharReader;
using Token = TrickyLib.Index.Lucene.Analysis.Token;
using Tokenizer = TrickyLib.Index.Lucene.Analysis.Tokenizer;
using AttributeSource = TrickyLib.Index.Lucene.Util.AttributeSource;
using Version = TrickyLib.Index.Lucene.Util.Version;

namespace TrickyLib.Index.Lucene.Analysis.Standard
{
	...
	public sealed class StandardTokenizer:Tokenizer
	{
	    ...
	    /// <see cref="TrickyLib.Index.Lucene.Analysis.Standard.StandardTokenizer" />. Attaches
		...
		/// <see cref="TrickyLib.Index.Lucene.Util.AttributeSource.AttributeFactory" />
		/// </summary>
		...
		///<summary>
		/// (non-Javadoc)
		/// <see cref="TrickyLib.Index.Lucene.Analysis.TokenStream.IncrementToken()" />
        ///</summary>
