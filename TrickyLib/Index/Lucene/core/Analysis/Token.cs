...
using System;
using TrickyLib.Index.Lucene.Analysis.Tokenattributes;
using TrickyLib.Index.Lucene.Support;
using TrickyLib.Index.Lucene.Util;
using Payload = TrickyLib.Index.Lucene.Index.Payload;
using TermPositions = TrickyLib.Index.Lucene.Index.TermPositions;
using ArrayUtil = TrickyLib.Index.Lucene.Util.ArrayUtil;
using Attribute = TrickyLib.Index.Lucene.Util.Attribute;

namespace TrickyLib.Index.Lucene.Analysis
{
	...
	/// that are part of core Lucene and can be found in the <see cref="TrickyLib.Index.Lucene.Analysis.Tokenattributes"/> namespace.
	...
	/// <p/>
	/// </summary>
	/// <seealso cref="TrickyLib.Index.Lucene.Index.Payload">
	/// </seealso>
	[Serializable]
	public class Token : Attribute, ITermAttribute, ITypeAttribute, IPositionIncrementAttribute, IFlagsAttribute, IOffsetAttribute, IPayloadAttribute
	{
	    ...
	    /// <seealso cref="TrickyLib.Index.Lucene.Index.TermPositions">
	    /// </seealso>
