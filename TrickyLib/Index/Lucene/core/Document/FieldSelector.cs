...
namespace TrickyLib.Index.Lucene.Documents
{
	...
	/// what Fields get loaded on a <see cref="Document" /> by <see cref="TrickyLib.Index.Lucene.Index.IndexReader.Document(int,TrickyLib.Index.Lucene.Documents.FieldSelector)" />
	/// </summary>
