...
using DefaultSimilarity = TrickyLib.Index.Lucene.Search.DefaultSimilarity;
...
namespace TrickyLib.Index.Lucene.Index
{
    ...
    public class DirectoryReader:IndexReader
    {
        /*new*/ private class AnonymousClassFindSegmentsFile:SegmentInfos.FindSegmentsFile
        {
            ...
            internal AnonymousClassFindSegmentsFile(bool readOnly, TrickyLib.Index.Lucene.Index.IndexDeletionPolicy deletionPolicy, int termInfosIndexDivisor, TrickyLib.Index.Lucene.Store.Directory Param1):base(Param1)
            {
        ...
        private class AnonymousClassFindSegmentsFile1:SegmentInfos.FindSegmentsFile
        {
            ...
            internal AnonymousClassFindSegmentsFile1(bool openReadOnly, DirectoryReader enclosingInstance, TrickyLib.Index.Lucene.Store.Directory Param1):base(Param1)
            {
        ...
        /// <throws>  TrickyLib.Index.Lucene.Store.LockObtainFailedException </throws>
        ...
        /// <seealso cref="TrickyLib.Index.Lucene.Index.IndexReader.ListCommits">
        /// </seealso>
