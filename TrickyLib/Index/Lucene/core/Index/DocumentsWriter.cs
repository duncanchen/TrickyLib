...
using ArrayUtil = TrickyLib.Index.Lucene.Util.ArrayUtil;
using Constants = TrickyLib.Index.Lucene.Util.Constants;
using IndexSearcher = TrickyLib.Index.Lucene.Search.IndexSearcher;
...
namespace TrickyLib.Index.Lucene.Index
{
	...
	public sealed class DocumentsWriter : IDisposable
	{
        ...
        */
        internal class PerDocBuffer : TrickyLib.Index.Lucene.Store.RAMFile
        {
