...
using Document = TrickyLib.Index.Lucene.Documents.Document;
using FieldSelector = TrickyLib.Index.Lucene.Documents.FieldSelector;
using TrickyLib.Index.Lucene.Store;
using Similarity = TrickyLib.Index.Lucene.Search.Similarity;
...
namespace TrickyLib.Index.Lucene.Index
{
	...
	/// one of the static <c>open()</c> methods, e.g. <see cref="Open(TrickyLib.Index.Lucene.Store.Directory, bool)" />
	///.
	...
	public abstract class IndexReader : System.ICloneable, System.IDisposable
	{
		...
		{
			private void  InitBlock(TrickyLib.Index.Lucene.Store.Directory directory2)
			{
				this.directory2 = directory2;
			}
			private TrickyLib.Index.Lucene.Store.Directory directory2;
			internal AnonymousClassFindSegmentsFile(TrickyLib.Index.Lucene.Store.Directory directory2, TrickyLib.Index.Lucene.Store.Directory Param1):base(Param1)
			{
	    ...
	    /// <see cref="Open(TrickyLib.Index.Lucene.Store.Directory, bool)" />, or <see cref="Reopen()" /> 
		...
		/// <seealso cref="TrickyLib.Index.Lucene.Documents.Field.TermVector">
		/// </seealso>
		...
		/// <summary> Get the <see cref="TrickyLib.Index.Lucene.Documents.Document" /> at the <c>n</c>
		/// <sup>th</sup> position. The <see cref="FieldSelector" /> may be used to determine
		/// what <see cref="TrickyLib.Index.Lucene.Documents.Field" />s to load and how they should
		/// be loaded. <b>NOTE:</b> If this Reader (more specifically, the underlying
		/// <c>FieldsReader</c>) is closed before the lazy
		/// <see cref="TrickyLib.Index.Lucene.Documents.Field" /> is loaded an exception may be
		/// thrown. If you want the value of a lazy
		/// <see cref="TrickyLib.Index.Lucene.Documents.Field" /> to be available after closing you
		...
		/// <see cref="TrickyLib.Index.Lucene.Documents.Document" /> at the nth position
		/// </returns>
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
		/// <seealso cref="IFieldable">
		/// </seealso>
		/// <seealso cref="TrickyLib.Index.Lucene.Documents.FieldSelector">
		/// </seealso>
		/// <seealso cref="TrickyLib.Index.Lucene.Documents.SetBasedFieldSelector">
		/// </seealso>
		/// <seealso cref="TrickyLib.Index.Lucene.Documents.LoadFirstFieldSelector">
		/// </seealso>
		...
		/// </summary>
        /// <seealso cref="TrickyLib.Index.Lucene.Documents.AbstractField.Boost" />
        ...
        /// <summary>Returns an unpositioned <see cref="TrickyLib.Index.Lucene.Index.TermDocs" /> enumerator.</summary>
        /// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
        ...
        /// <summary>Returns an unpositioned <see cref="TrickyLib.Index.Lucene.Index.TermPositions" /> enumerator.</summary>
        /// <exception cref="System.IO.IOException">If there is a low-level IO error</exception>
		...
		/// </summary>
		/// <param name="args">Usage: TrickyLib.Index.Lucene.Index.IndexReader [-extract] &lt;cfsfile&gt;
		/// </param>
		[STAThread]
		public static void  Main(String[] args)
		{
	    	...
	    	if (filename == null)
			{
				System.Console.Out.WriteLine("Usage: TrickyLib.Index.Lucene.Index.IndexReader [-extract] <cfsfile>");
				return ;
			}
	    ...
	    /// through <see cref="IndexReader.Open(TrickyLib.Index.Lucene.Store.Directory,bool)" />. Use the parent reader directly. 
	    /// </summary>
