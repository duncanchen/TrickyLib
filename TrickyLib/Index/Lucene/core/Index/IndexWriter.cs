...
using Analyzer = TrickyLib.Index.Lucene.Analysis.Analyzer;
using Document = TrickyLib.Index.Lucene.Documents.Document;
using IndexingChain = TrickyLib.Index.Lucene.Index.DocumentsWriter.IndexingChain;
using AlreadyClosedException = TrickyLib.Index.Lucene.Store.AlreadyClosedException;
using BufferedIndexInput = TrickyLib.Index.Lucene.Store.BufferedIndexInput;
using Directory = TrickyLib.Index.Lucene.Store.Directory;
using Lock = TrickyLib.Index.Lucene.Store.Lock;
using LockObtainFailedException = TrickyLib.Index.Lucene.Store.LockObtainFailedException;
using Constants = TrickyLib.Index.Lucene.Util.Constants;
using Query = TrickyLib.Index.Lucene.Search.Query;
...
namespace TrickyLib.Index.Lucene.Index
{
    ...
    */
    public class IndexWriter : System.IDisposable
	{
        ...
        private ISet<SegmentInfo> segmentsToOptimize = TrickyLib.Index.Lucene.Support.Compatibility.SetFactory.CreateHashSet<SegmentInfo>(); // used by optimize to note those needing optimization
		...
		private ISet<MergePolicy.OneMerge> runningMerges = TrickyLib.Index.Lucene.Support.Compatibility.SetFactory.CreateHashSet<MergePolicy.OneMerge>();
		...
		/// using <see cref="IndexReader.Open(TrickyLib.Index.Lucene.Store.Directory, bool)" /> to open a new reader. But the turarnound
		...
		/// <param name="deletionPolicy">see <a href="#deletionPolicy">above</a>
		/// </param>
		/// <param name="mfl"><see cref="TrickyLib.Index.Lucene.Index.IndexWriter.MaxFieldLength" />, whether or not to limit field lengths.  Value is in number of terms/tokens
		/// </param>
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  LockObtainFailedException if another writer </throws>
		/// <summary>  has this index open (<c>write.lock</c> could not
		...
		/// <param name="deletionPolicy">see <a href="#deletionPolicy">above</a>
		/// </param>
		/// <param name="mfl">whether or not to limit field lengths, value is in number of terms/tokens.  See <see cref="TrickyLib.Index.Lucene.Index.IndexWriter.MaxFieldLength" />.
		/// </param>
		...
		public virtual void  Optimize(int maxNumSegments, bool doWait)
		{
			...
			lock (this)
			{
                ...
                segmentsToOptimize = TrickyLib.Index.Lucene.Support.Compatibility.SetFactory.CreateHashSet<SegmentInfo>();
		...
		* addIndexesNoOptimize(). */
		...
		public sealed class MaxFieldLength
		{
			...
			{
				LIMITED = new MaxFieldLength("LIMITED", TrickyLib.Index.Lucene.Index.IndexWriter.DEFAULT_MAX_FIELD_LENGTH);
			}
		}
