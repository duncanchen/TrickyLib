...
using MultiTermDocs = TrickyLib.Index.Lucene.Index.DirectoryReader.MultiTermDocs;
using MultiTermEnum = TrickyLib.Index.Lucene.Index.DirectoryReader.MultiTermEnum;
using MultiTermPositions = TrickyLib.Index.Lucene.Index.DirectoryReader.MultiTermPositions;
...
namespace TrickyLib.Index.Lucene.Index
{
    ...
    public class MultiReader:IndexReader, System.ICloneable
    {
        ...
        protected internal override void  DoClose()
        {
            ...
            // not a good idea):
            TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.Purge(this);
        }
