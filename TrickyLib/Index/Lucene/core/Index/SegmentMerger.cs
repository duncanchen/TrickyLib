...
using FieldSelectorResult = TrickyLib.Index.Lucene.Documents.FieldSelectorResult;
using FieldOption = TrickyLib.Index.Lucene.Index.IndexReader.FieldOption;
using MergeAbortedException = TrickyLib.Index.Lucene.Index.MergePolicy.MergeAbortedException;
...
namespace TrickyLib.Index.Lucene.Index
{
	...
	public sealed class SegmentMerger
	{
		private class AnonymousClassCheckAbort:CheckAbort
		{
			...
			internal AnonymousClassCheckAbort(SegmentMerger enclosingInstance, TrickyLib.Index.Lucene.Index.MergePolicy.OneMerge Param1, TrickyLib.Index.Lucene.Store.Directory Param2):base(Param1, Param2)
			{
		...
		private class AnonymousClassCheckAbort1:CheckAbort
		{
			...
			internal AnonymousClassCheckAbort1(SegmentMerger enclosingInstance, TrickyLib.Index.Lucene.Index.MergePolicy.OneMerge Param1, TrickyLib.Index.Lucene.Store.Directory Param2):base(Param1, Param2)
			{
				InitBlock(enclosingInstance);
			}
			public override void  Work(double units)
		...
		{
            ISet<string> fileSet = TrickyLib.Index.Lucene.Support.Compatibility.SetFactory.CreateHashSet<string>();
