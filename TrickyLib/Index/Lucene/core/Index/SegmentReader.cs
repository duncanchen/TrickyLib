...
using BitVector = TrickyLib.Index.Lucene.Util.BitVector;
...
namespace TrickyLib.Index.Lucene.Index
{
	...
	public class SegmentReader : IndexReader
	{
			...
			internal void  DecRef()
			{
				lock (this)
				{
					...
					if (ref_Renamed.DecRef() == 0)
					{
                        ...
                        {
                            TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.Purge(origInstance);
                        }
					}
				}
			}
        ...
        public override System.Collections.Generic.ICollection<string> GetFieldNames(IndexReader.FieldOption fieldOption)
		{
            ...
            System.Collections.Generic.ISet<string> fieldSet = TrickyLib.Index.Lucene.Support.Compatibility.SetFactory.CreateHashSet<string>();
