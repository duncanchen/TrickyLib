...
using Occur = TrickyLib.Index.Lucene.Search.Occur;
...
namespace TrickyLib.Index.Lucene.Search
{
	...
	public class BooleanQuery : Query, System.Collections.Generic.IEnumerable<BooleanClause>, System.ICloneable
	{
		...
		private class AnonymousClassSimilarityDelegator:SimilarityDelegator
		{
			...
			internal AnonymousClassSimilarityDelegator(BooleanQuery enclosingInstance, TrickyLib.Index.Lucene.Search.Similarity Param1):base(Param1)
			{
		...
		public class TooManyClauses:System.SystemException
		{
			public override System.String Message
			{
				get
				{
					return "maxClauseCount is set to " + TrickyLib.Index.Lucene.Search.BooleanQuery._maxClauses;
				}
