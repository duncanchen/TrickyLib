...
using Term = TrickyLib.Index.Lucene.Index.Term;
using TermDocs = TrickyLib.Index.Lucene.Index.TermDocs;
using TermEnum = TrickyLib.Index.Lucene.Index.TermEnum;
using FieldCacheSanityChecker = TrickyLib.Index.Lucene.Util.FieldCacheSanityChecker;
using Single = TrickyLib.Index.Lucene.Support.Single;
using StringHelper = TrickyLib.Index.Lucene.Util.StringHelper;
...
namespace TrickyLib.Index.Lucene.Search
{
    ...
    class FieldCacheImpl : FieldCache
    {
        ...
        // TrickyLib.Index.Lucene: java version 3.0.3 with patch in rev. 912330 applied:
        ...
        internal sealed class ByteCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    return wrapper.GetBytes(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT_BYTE_PARSER);
                }
        ...
        internal sealed class ShortCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    return wrapper.GetShorts(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT_SHORT_PARSER);
                }
        ...
        internal sealed class IntCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetInts(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT_INT_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetInts(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.NUMERIC_UTILS_INT_PARSER);
                    }
                }
                int[] retArray = null;
                TermDocs termDocs = reader.TermDocs();
        ...
        internal sealed class FloatCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                ...
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetFloats(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT_FLOAT_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetFloats(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.NUMERIC_UTILS_FLOAT_PARSER);
                    }
                }
                float[] retArray = null;
                TermDocs termDocs = reader.TermDocs();
        ...
        // inherit javadocs
        public virtual long[] GetLongs(IndexReader reader, System.String field, TrickyLib.Index.Lucene.Search.LongParser parser)
        {
        ...
        internal sealed class LongCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                Entry entry = entryKey;
                System.String field = entry.field;
                TrickyLib.Index.Lucene.Search.LongParser parser = (TrickyLib.Index.Lucene.Search.LongParser) entry.custom;
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetLongs(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT_LONG_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetLongs(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.NUMERIC_UTILS_LONG_PARSER);
                    }
                }
                long[] retArray = null;
                TermDocs termDocs = reader.TermDocs();
        ...
        // inherit javadocs
        public virtual double[] GetDoubles(IndexReader reader, System.String field, TrickyLib.Index.Lucene.Search.DoubleParser parser)
        {
        ...
        internal sealed class DoubleCache:Cache
        {
            ...
            protected internal override System.Object CreateValue(IndexReader reader, Entry entryKey)
            {
                Entry entry = entryKey;
                System.String field = entry.field;
                TrickyLib.Index.Lucene.Search.DoubleParser parser = (TrickyLib.Index.Lucene.Search.DoubleParser) entry.custom;
                if (parser == null)
                {
                    try
                    {
                        return wrapper.GetDoubles(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT_DOUBLE_PARSER);
                    }
                    catch (System.FormatException)
                    {
                        return wrapper.GetDoubles(reader, field, TrickyLib.Index.Lucene.Search.FieldCache_Fields.NUMERIC_UTILS_DOUBLE_PARSER);
                    }
                }
