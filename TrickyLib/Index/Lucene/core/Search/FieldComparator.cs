...
using ByteParser = TrickyLib.Index.Lucene.Search.ByteParser;
using DoubleParser = TrickyLib.Index.Lucene.Search.DoubleParser;
using FloatParser = TrickyLib.Index.Lucene.Search.FloatParser;
using IntParser = TrickyLib.Index.Lucene.Search.IntParser;
using LongParser = TrickyLib.Index.Lucene.Search.LongParser;
using ShortParser = TrickyLib.Index.Lucene.Search.ShortParser;
using StringIndex = TrickyLib.Index.Lucene.Search.StringIndex;
...
namespace TrickyLib.Index.Lucene.Search
{
	...
	/// 
    /// <item> <see cref="P:TrickyLib.Index.Lucene.Search.FieldComparator.Item(System.Int32)" /> Return the sort value stored in
	...
	public abstract class FieldComparator
	{
	    ...
	    /// <summary>Parses field's values as byte (using <see cref="FieldCache.GetBytes(TrickyLib.Index.Lucene.Index.IndexReader,string)" />
		...
		public sealed class ByteComparator:FieldComparator
		{
			...
			internal ByteComparator(int numHits, System.String field, TrickyLib.Index.Lucene.Search.Parser parser)
			{
			...
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetBytes(reader, field, parser);
			}
		...
		/// <summary>Parses field's values as double (using <see cref="FieldCache.GetDoubles(TrickyLib.Index.Lucene.Index.IndexReader,string)" />
		/// and sorts by ascending value 
		/// </summary>
		public sealed class DoubleComparator:FieldComparator
		{
			...
			internal DoubleComparator(int numHits, System.String field, TrickyLib.Index.Lucene.Search.Parser parser)
			{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetDoubles(reader, field, parser);
			}
		...
		/// <summary>Parses field's values as float (using <see cref="FieldCache.GetFloats(TrickyLib.Index.Lucene.Index.IndexReader,string)" />
		/// and sorts by ascending value 
		/// </summary>
		public sealed class FloatComparator:FieldComparator
		{
			...
			internal FloatComparator(int numHits, System.String field, TrickyLib.Index.Lucene.Search.Parser parser)
			{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetFloats(reader, field, parser);
			}
		...
		/// <summary>Parses field's values as int (using <see cref="FieldCache.GetInts(TrickyLib.Index.Lucene.Index.IndexReader,string)" />
		/// and sorts by ascending value 
		/// </summary>
		public sealed class IntComparator:FieldComparator
		{
			...
			internal IntComparator(int numHits, System.String field, TrickyLib.Index.Lucene.Search.Parser parser)
			{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetInts(reader, field, parser);
			}
		...
		/// <summary>Parses field's values as long (using <see cref="FieldCache.GetLongs(TrickyLib.Index.Lucene.Index.IndexReader,string)" />
		/// and sorts by ascending value 
		/// </summary>
		public sealed class LongComparator:FieldComparator
		{
			...
			internal LongComparator(int numHits, System.String field, TrickyLib.Index.Lucene.Search.Parser parser)
			{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetLongs(reader, field, parser);
			}
		...
		public sealed class ShortComparator:FieldComparator
		{
			...
			internal ShortComparator(int numHits, System.String field, TrickyLib.Index.Lucene.Search.Parser parser)
			{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetShorts(reader, field, parser);
			}
		...
		public sealed class StringComparatorLocale:FieldComparator
		{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetStrings(reader, field);
			}
		...
		public sealed class StringOrdValComparator:FieldComparator
		{
			...
			public override void  SetNextReader(IndexReader reader, int docBase)
			{
				StringIndex currentReaderValues = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetStringIndex(reader, field);
				currentReaderGen++;
