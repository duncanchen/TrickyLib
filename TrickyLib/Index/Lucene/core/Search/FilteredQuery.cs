...
namespace TrickyLib.Index.Lucene.Search
{
	...
	public class FilteredQuery:Query
	{
		...
		{
			public AnonymousClassWeight(TrickyLib.Index.Lucene.Search.Weight weight, TrickyLib.Index.Lucene.Search.Similarity similarity, FilteredQuery enclosingInstance)
			{
				InitBlock(weight, similarity, enclosingInstance);
			}
			private class AnonymousClassScorer:Scorer
			{
				private void  InitBlock(TrickyLib.Index.Lucene.Search.Scorer scorer, TrickyLib.Index.Lucene.Search.DocIdSetIterator docIdSetIterator, AnonymousClassWeight enclosingInstance)
				{
					this.scorer = scorer;
					this.docIdSetIterator = docIdSetIterator;
					this.enclosingInstance = enclosingInstance;
				}
				private TrickyLib.Index.Lucene.Search.Scorer scorer;
				private TrickyLib.Index.Lucene.Search.DocIdSetIterator docIdSetIterator;
				...
				internal AnonymousClassScorer(TrickyLib.Index.Lucene.Search.Scorer scorer, TrickyLib.Index.Lucene.Search.DocIdSetIterator docIdSetIterator, AnonymousClassWeight enclosingInstance, TrickyLib.Index.Lucene.Search.Similarity Param1):base(Param1)
				{
			...
			private void  InitBlock(TrickyLib.Index.Lucene.Search.Weight weight, TrickyLib.Index.Lucene.Search.Similarity similarity, FilteredQuery enclosingInstance)
			{
				this.weight = weight;
				this.similarity = similarity;
				this.enclosingInstance = enclosingInstance;
			}
			private TrickyLib.Index.Lucene.Search.Weight weight;
			private TrickyLib.Index.Lucene.Search.Similarity similarity;
