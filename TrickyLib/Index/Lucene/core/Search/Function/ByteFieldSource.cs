...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	public class ByteFieldSource:FieldCacheSource
	{
		...
		private TrickyLib.Index.Lucene.Search.ByteParser parser;
		...
		public ByteFieldSource(System.String field, TrickyLib.Index.Lucene.Search.ByteParser parser):base(field)
		{
			this.parser = parser;
		}
