...
using ComplexExplanation = TrickyLib.Index.Lucene.Search.ComplexExplanation;
...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	/// <see cref="TrickyLib.Index.Lucene.Search.Function.FieldScoreQuery">FieldScoreQuery</see></item>
	/// </list>
	...
	public class CustomScoreQuery:Query, System.ICloneable
	{
		...
		/// <see cref="TrickyLib.Index.Lucene.Search.Function.FieldScoreQuery">FieldScoreQuery</see>.
		...
		/// <see cref="TrickyLib.Index.Lucene.Search.Function.FieldScoreQuery">FieldScoreQueries</see>.
		/// This parameter is optional - it can be null or even an empty array.
		/// </param>
		...
		/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Query.rewrite(TrickyLib.Index.Lucene.Index.IndexReader) */
		...
		/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Query.extractTerms(java.util.Set) */
		...
		/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Query.clone() */
		...
		/* (non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Query.toString(java.lang.String) */
		...
		private class CustomWeight:Weight
		{
			...
			/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Weight.getQuery() */
		    ...
		    /*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Weight.getValue() */
		    ...
		    /*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Weight.sumOfSquaredWeights() */
		    ...
		    /*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Weight.normalize(float) */
		...
		private class CustomScorer:Scorer
		{
			...
			/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Scorer.score() */
