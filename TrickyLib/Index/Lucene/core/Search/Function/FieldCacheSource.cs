...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	/// a single field from the <see cref="TrickyLib.Index.Lucene.Search.FieldCache">FieldCache</see>.
	/// <p/>
	...
	public abstract class FieldCacheSource:ValueSource
	{
		...
		{
			return GetCachedFieldValues(TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT, field, reader);
		}
