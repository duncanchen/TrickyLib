...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	public class IntFieldSource:FieldCacheSource
	{
		...
		private TrickyLib.Index.Lucene.Search.IntParser parser;
		...
		public IntFieldSource(System.String field, TrickyLib.Index.Lucene.Search.IntParser parser):base(field)
		{
			this.parser = parser;
		}
