...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	/// <see cref="TrickyLib.Index.Lucene.Search.FieldCache">FieldCache</see> using getStringIndex()
	...
	public class ReverseOrdFieldSource:ValueSource
	{
		private class AnonymousClassDocValues:DocValues
		{
			...
			/* (non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Function.DocValues.intVal(int) */
			public override int IntVal(int doc)
			{
				return end - arr[doc];
			}
			/* (non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Function.DocValues.strVal(int) */
		...
		/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Function.ValueSource.getValues(TrickyLib.Index.Lucene.Index.IndexReader) */
		public override DocValues GetValues(IndexReader reader)
		{
			TrickyLib.Index.Lucene.Search.StringIndex sindex = TrickyLib.Index.Lucene.Search.FieldCache_Fields.DEFAULT.GetStringIndex(reader, field);
