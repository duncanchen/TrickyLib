...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	public class ShortFieldSource:FieldCacheSource
	{
		...
		private TrickyLib.Index.Lucene.Search.ShortParser parser;
		...
		public ShortFieldSource(System.String field, TrickyLib.Index.Lucene.Search.ShortParser parser):base(field)
		{
			this.parser = parser;
		}
