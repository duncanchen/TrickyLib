...
namespace TrickyLib.Index.Lucene.Search.Function
{
	...
	/// values obtained from a <see cref="TrickyLib.Index.Lucene.Search.Function.ValueSource">ValueSource</see>.
	/// <p/>
	...
	public class ValueSourceQuery:Query
	{
		...
		internal class ValueSourceWeight:Weight
		{
			...
			/*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Weight.explain(TrickyLib.Index.Lucene.Index.IndexReader, int) */
        ...
        private class ValueSourceScorer : Scorer
        {
            ...
            /*(non-Javadoc) <see cref="TrickyLib.Index.Lucene.Search.Scorer.explain(int) */
