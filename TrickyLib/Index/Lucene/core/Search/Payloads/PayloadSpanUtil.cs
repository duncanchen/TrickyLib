...
using BooleanClause = TrickyLib.Index.Lucene.Search.BooleanClause;
using BooleanQuery = TrickyLib.Index.Lucene.Search.BooleanQuery;
using DisjunctionMaxQuery = TrickyLib.Index.Lucene.Search.DisjunctionMaxQuery;
using FilteredQuery = TrickyLib.Index.Lucene.Search.FilteredQuery;
using MultiPhraseQuery = TrickyLib.Index.Lucene.Search.MultiPhraseQuery;
using PhraseQuery = TrickyLib.Index.Lucene.Search.PhraseQuery;
using Query = TrickyLib.Index.Lucene.Search.Query;
using TermQuery = TrickyLib.Index.Lucene.Search.TermQuery;
using SpanNearQuery = TrickyLib.Index.Lucene.Search.Spans.SpanNearQuery;
using SpanOrQuery = TrickyLib.Index.Lucene.Search.Spans.SpanOrQuery;
