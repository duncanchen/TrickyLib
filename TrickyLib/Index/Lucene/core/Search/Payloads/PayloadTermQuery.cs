...
using TermPositions = TrickyLib.Index.Lucene.Index.TermPositions;
...
using SpanTermQuery = TrickyLib.Index.Lucene.Search.Spans.SpanTermQuery;
using SpanWeight = TrickyLib.Index.Lucene.Search.Spans.SpanWeight;
using TermSpans = TrickyLib.Index.Lucene.Search.Spans.TermSpans;

namespace TrickyLib.Index.Lucene.Search.Payloads
{
	
	/// <summary> This class is very similar to
	/// <see cref="TrickyLib.Index.Lucene.Search.Spans.SpanTermQuery" /> except that it factors
	/// in the value of the payload located at each of the positions where the
	/// <see cref="TrickyLib.Index.Lucene.Index.Term" /> occurs.
	/// <p/>
	/// In order to take advantage of this, you must override
    /// <see cref="TrickyLib.Index.Lucene.Search.Similarity.ScorePayload(int, String, int, int, byte[],int,int)" />
