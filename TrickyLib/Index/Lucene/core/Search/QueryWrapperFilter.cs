...
namespace TrickyLib.Index.Lucene.Search
{
	...
	public class QueryWrapperFilter:Filter
	{
		...
		{
			public AnonymousClassDocIdSet(TrickyLib.Index.Lucene.Search.Weight weight, TrickyLib.Index.Lucene.Index.IndexReader reader, QueryWrapperFilter enclosingInstance)
			{
				InitBlock(weight, reader, enclosingInstance);
			}
			private void  InitBlock(TrickyLib.Index.Lucene.Search.Weight weight, TrickyLib.Index.Lucene.Index.IndexReader reader, QueryWrapperFilter enclosingInstance)
			{
				this.weight = weight;
				this.reader = reader;
