...
namespace TrickyLib.Index.Lucene.Search.Spans
{
	...
	public class SpanFirstQuery : SpanQuery, System.ICloneable
	{
		...
		{
			public AnonymousClassSpans(TrickyLib.Index.Lucene.Index.IndexReader reader, SpanFirstQuery enclosingInstance)
			{
				InitBlock(reader, enclosingInstance);
			}
			private void  InitBlock(TrickyLib.Index.Lucene.Index.IndexReader reader, SpanFirstQuery enclosingInstance)
			{
				this.reader = reader;
				this.enclosingInstance = enclosingInstance;
				spans = Enclosing_Instance.match.GetSpans(reader);
			}
			private TrickyLib.Index.Lucene.Index.IndexReader reader;
