...
namespace TrickyLib.Index.Lucene.Search.Spans
{
	...
	public class SpanNotQuery:SpanQuery, System.ICloneable
	{
		...
		{
			public AnonymousClassSpans(TrickyLib.Index.Lucene.Index.IndexReader reader, SpanNotQuery enclosingInstance)
			{
				InitBlock(reader, enclosingInstance);
			}
			private void  InitBlock(TrickyLib.Index.Lucene.Index.IndexReader reader, SpanNotQuery enclosingInstance)
			{
				this.reader = reader;
