...
namespace TrickyLib.Index.Lucene.Search.Spans
{
	...
	public class SpanOrQuery : SpanQuery, System.ICloneable
	{
		...
		{
			public AnonymousClassSpans(TrickyLib.Index.Lucene.Index.IndexReader reader, SpanOrQuery enclosingInstance)
			{
				InitBlock(reader, enclosingInstance);
			}
			private void  InitBlock(TrickyLib.Index.Lucene.Index.IndexReader reader, SpanOrQuery enclosingInstance)
			{
				this.reader = reader;
