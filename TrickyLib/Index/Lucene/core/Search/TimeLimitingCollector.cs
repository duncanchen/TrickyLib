		...
		private sealed class TimerThread:ThreadClass
		{
			...
			override public void  Run()
			{
				while (true)
				{
					...
					time += TrickyLib.Index.Lucene.Search.TimeLimitingCollector.resolution;
					System.Threading.Thread.Sleep(new System.TimeSpan((System.Int64) 10000 * TrickyLib.Index.Lucene.Search.TimeLimitingCollector.resolution));
