...
{
	/// <summary> A base class for all collectors that return a <see cref="TrickyLib.Index.Lucene.Search.TopDocs" /> output. This
	...
	public abstract class TopDocsCollector<T> : Collector where T : ScoreDoc
	{
        ...
        /// <summary> Returns a <see cref="TrickyLib.Index.Lucene.Search.TopDocs" /> instance containing the given results. If
        ...
        /// with the returned <see cref="TrickyLib.Index.Lucene.Search.TopDocs" /> object, which will contain all the
        ...
        /// returned <see cref="TrickyLib.Index.Lucene.Search.TopDocs" /> object, which will contain all the results this
