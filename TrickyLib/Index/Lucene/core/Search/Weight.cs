...
namespace TrickyLib.Index.Lucene.Search
{
	...
	/// <c>Searcher</c> (<see cref="TrickyLib.Index.Lucene.Search.Query.CreateWeight(Searcher)" />).</item>
	...
	public abstract class Weight
	{
		...
		/// </summary>
		/// <param name="reader">
        /// the <see cref="IndexReader" /> for which to return the <see cref="TrickyLib.Index.Lucene.Search.Scorer" />.
		/// </param>
        ...
        /// if true, <see cref="TrickyLib.Index.Lucene.Search.Scorer.Score(TrickyLib.Index.Lucene.Search.Collector)" /> will be called; if false,
	    ...
	    /// <see cref="Scorer(TrickyLib.Index.Lucene.Index.IndexReader, bool, bool)" /> to
