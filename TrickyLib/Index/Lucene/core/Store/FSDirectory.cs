...
using IndexFileNameFilter = TrickyLib.Index.Lucene.Index.IndexFileNameFilter;
using IndexWriter = TrickyLib.Index.Lucene.Index.IndexWriter;
...
namespace TrickyLib.Index.Lucene.Store
{
	...
	public abstract class FSDirectory : Directory
	{
		...
		/// This method should be used in <see cref="TrickyLib.Index.Lucene.Store.Directory.CreateOutput(string)" />. 
		/// </summary>
		...
		protected internal FSDirectory(System.IO.DirectoryInfo path, LockFactory lockFactory)
		{
            ...
            // system property TrickyLib.Index.Lucene.Store.FSDirectoryLockFactoryClass is set,
		...
		public static FSDirectory Open(System.IO.DirectoryInfo path, LockFactory lockFactory)
		{
			...
			*/
			...
			{
                //NIOFSDirectory is not implemented in TrickyLib.Index.Lucene
        ...
        // For TrickyLib.Index.Lucene, GetDirectory() is more appropriate
