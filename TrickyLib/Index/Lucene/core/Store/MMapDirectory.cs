...
namespace TrickyLib.Index.Lucene.Store
{
	...
	public class MMapDirectory:FSDirectory
	{
		private class AnonymousClassPrivilegedExceptionAction // : SupportClass.IPriviligedAction   // {{Aroush-2.9}}
		{
			...
			public virtual System.Object Run()
			{
                // {{Aroush-2.9
                /*
				System.Reflection.MethodInfo getCleanerMethod = buffer.GetType().GetMethod("cleaner", (TrickyLib.Index.Lucene.Store.MMapDirectory.NO_PARAM_TYPES == null)?new System.Type[0]:(System.Type[]) TrickyLib.Index.Lucene.Store.MMapDirectory.NO_PARAM_TYPES);
                getCleanerMethod.SetAccessible(true);
				System.Object cleaner = getCleanerMethod.Invoke(buffer, (System.Object[]) TrickyLib.Index.Lucene.Store.MMapDirectory.NO_PARAMS);
				if (cleaner != null)
				{
					cleaner.GetType().GetMethod("clean", (TrickyLib.Index.Lucene.Store.MMapDirectory.NO_PARAM_TYPES == null)?new System.Type[0]:(System.Type[]) TrickyLib.Index.Lucene.Store.MMapDirectory.NO_PARAM_TYPES).Invoke(cleaner, (System.Object[]) TrickyLib.Index.Lucene.Store.MMapDirectory.NO_PARAMS);
				}
                */
