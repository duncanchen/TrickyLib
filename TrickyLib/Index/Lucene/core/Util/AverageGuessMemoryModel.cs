...
namespace TrickyLib.Index.Lucene.Util
{
	...
	public class AverageGuessMemoryModel:MemoryModel
	{
		...
		* (non-Javadoc)
		* 
		* <see cref="TrickyLib.Index.Lucene.Util.MemoryModel.getArraySize()"/>
		*/
		...
		* (non-Javadoc)
		* 
		* <see cref="TrickyLib.Index.Lucene.Util.MemoryModel.getClassSize()"/>
		*/
	    ...
	    /* (non-Javadoc)
		* <see cref="TrickyLib.Index.Lucene.Util.MemoryModel.getPrimitiveSize(java.lang.Class)"/>
		*/
		...
		/* (non-Javadoc)
		* <see cref="TrickyLib.Index.Lucene.Util.MemoryModel.getReferenceSize()"/>
		*/
