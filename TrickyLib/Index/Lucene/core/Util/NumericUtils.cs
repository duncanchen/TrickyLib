...
namespace TrickyLib.Index.Lucene.Util
{
	...
	public sealed class NumericUtils
	{
		...
		/// <see cref="TrickyLib.Index.Lucene.Search.BooleanQuery" /> for each call to its
		...
		public abstract class LongRangeBuilder
		{
			...
			{
				AddRange(TrickyLib.Index.Lucene.Util.NumericUtils.LongToPrefixCoded(min, shift), TrickyLib.Index.Lucene.Util.NumericUtils.LongToPrefixCoded(max, shift));
			}
		}
		...
		public abstract class IntRangeBuilder
		{
			...
			{
				AddRange(TrickyLib.Index.Lucene.Util.NumericUtils.IntToPrefixCoded(min, shift), TrickyLib.Index.Lucene.Util.NumericUtils.IntToPrefixCoded(max, shift));
			}
		}
	}
}